...
function iniciarTetris() {
    ...
    function rotateShape() {
        const rotatedShape = currentShape.shape[0].map((_, i) => 
        ...
        if (collides()) {
            currentShape.shape = previousShape; // Revierte si colisiona
        }
    }
    ...
    intervalID = setInterval(update, 100); // Adjust interval for game speed
}

function pararTetris() {
    isRunning = false;
